...
if(isset($dataInput['birth'])){
   $newDate = date("d-m-Y", strtotime($dataInput['birth'])) ;
}

$dataError = isset($arr) ? $arr : [];
?>
<div class="wrapper">
   <div class="container">
      <div class="mb-30">
      ...
      <div class="form">
         <form class="" action="/User/user_create" method="POST" enctype="multipart/form-data">
            <div class="div-center">
               <div class="div-label"><label for="title" class="bold">Username<span class="red-span">*</span></label></div>
               <input class="input-center" name="username" type="text" id="username" value="<?php echo isset($dataInput['username']) ? $dataInput['username'] : ''; ?>" autocomplete="off">
            </div>
            ...
            <div class="div-label"><label for="title" class="bold">Password<span class="red-span">*</span></label></div>
               <input class="input-center" name="password" type="text" id="password" value="<?php echo isset($dataInput['password']) ? $dataInput['password'] : ''; ?>"autocomplete="off">
            </div>
            ...
            <input checked name="sex_input" class="" type="radio" value="male" <?php if (isset($dataInput['sex']) &&  $dataInput['sex'] == "male") {
                                                                                    echo "checked";
                                                                                 } else {
                                                                                    echo "";
                                                                                 } ?>><span class="mr10">Male</span>
               <input name="sex_input" class="" type="radio" value="female" <?php if (isset($dataInput['sex']) &&  $dataInput['sex'] == "female") {
                                                                                       echo "checked";
                                                                                    } else {
                                                                                       echo "";
            ...
            <div class="div-label"><label for="title" class="bold">Email<span class="red-span">*</span></label></div>
               <input class="input-center" name="email" type="text" id="email" value="<?php echo isset($dataInput['email']) ? $dataInput['email'] : ''; ?>" autocomplete="off">
            </div>
            ...
            <div class="div-label"><label for="title" class="bold">Job<span class="red-span">*</span></label></div>
               <input class=" input-center" name="job" type="text" id="job" value="<?php echo isset($dataInput['job']) ? $dataInput['job'] : ''; ?>" autocomplete="off">
            </div>
            ...
            <div class="div-label"><label for="title" class="bold">School</label></div>
               <input class="input-center" name="school" type="text" id="school" value="<?php echo isset($dataInput['school']) ? $dataInput['school'] : ''; ?>" autocomplete="off">
            </div>
            <div class="div-center">
            <div class="div-label"><label for="title" class="bold">Experience</label></div>
               <textarea class="input-center" name="experience" id="experience" rows="4" autocomplete="off"><?php echo isset($dataInput['experience']) ? $dataInput['experience'] : ''; ?></textarea>
            </div>
            <div class="div-center">
            <div class="div-label"><label for="title" class="bold">Photo</label></div>
               <input style="border: none; padding-left: 0px;" class="input-center" accept="image/*" class="" name="photo" type="file" id="photo" value="<?php echo isset($dataInput['photo']) ? $dataInput['photo'] : ''; ?>">
